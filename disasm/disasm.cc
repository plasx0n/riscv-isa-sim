...
DEFINE_R3TYPE(tb_maxsub)
DEFINE_R3TYPE(tb_mm_blendv_epi8)
DEFINE_R3TYPE(tb_mmax)
DEFINE_R3TYPE(tb_conc_add)
DEFINE_R3TYPE(tb_max_add_sub)
DEFINE_RTYPE(pl_f)
DEFINE_RTYPE(pl_r)
