...
void disassembler_t::add_instructions(const isa_parser_t* isa)
{
  ...
  // FEC 
DEFINE_RTYPE(tb_subsat)
DEFINE_RTYPE(tb_addsat)
DEFINE_RTYPE(tb_max)
DEFINE_RTYPE(tb_vmax)
DEFINE_RTYPE(tb_scale)
DEFINE_RTYPE(tb_vsrls)
DEFINE_RTYPE(tb_div2add)
DEFINE_RTYPE(tb_div2sub)
DEFINE_RTYPE(tb_sat63)
DEFINE_RTYPE(tb_vsubs)
DEFINE_RTYPE(tb_vadds)
DEFINE_RTYPE(tb_div34)
DEFINE_RTYPE(tb_shuffle)
DEFINE_RTYPE(tb_vsubsat)
DEFINE_RTYPE(tb_vaddscale)
DEFINE_R3TYPE(tb3_accumax)
DEFINE_R3TYPE(tb3_accupp)
DEFINE_R3TYPE(tb3_accump)
DEFINE_R3TYPE(tb3_addllsa)
DEFINE_R3TYPE(tb3_maxpm)
DEFINE_R3TYPE(tb3_maxaddsub)
DEFINE_R3TYPE(tb3_blendv)
DEFINE_R3TYPE(tb3_concaddadd)
DEFINE_R3TYPE(tb3_concaddsub)
DEFINE_R3TYPE(tb3_addsrla)
DEFINE_R3TYPE(tb3_subsrla)
DEFINE_RTYPE(pl_f)
DEFINE_RTYPE(pl_r)
DEFINE_RTYPE(pl_addsat)
DEFINE_RTYPE(pl_subsat)
DEFINE_RTYPE(pl_decode)
DEFINE_RTYPE(pl_eval)
DEFINE_RTYPE(pl_rep_addlow)
DEFINE_RTYPE(pl_rep_addhi)
DEFINE_RTYPE(pl_rep_addsign)
DEFINE_RTYPE(pl_spc_acmp)
DEFINE_RTYPE(pl_spc_amin)
DEFINE_RTYPE(pl_spc_idup)
DEFINE_RTYPE(pl_spc_max)
DEFINE_RTYPE(pl_rep_addsum)
DEFINE_RTYPE(pl_spc_xorsum)
DEFINE_RTYPE(pl_spc_minapos)
DEFINE_R3TYPE(pl3_g)
DEFINE_R3TYPE(pl3_idx_min_comp)
DEFINE_R3TYPE(pl3_sc_update)
DEFINE_R3TYPE(pl3_findminpos)
DEFINE_RTYPE(ldn_add32u_sat64)
DEFINE_RTYPE(ldn_vidxminupdate2)
DEFINE_RTYPE(ldn_min)
DEFINE_RTYPE(ldn_sat8)
DEFINE_RTYPE(ldn_add32s_sat64)
DEFINE_RTYPE(ldn_sub32s_sat64)
DEFINE_RTYPE(ldn_vidxmincomp)
DEFINE_RTYPE(ldn_vidxminupdate)
DEFINE_RTYPE(ldn_extract)
DEFINE_R3TYPE(ldn3_maxsub)
DEFINE_R3TYPE(ldn3_copyxorvecto)
DEFINE_R3TYPE(ldn3_readVn)
DEFINE_R3TYPE(ldn3_addsatmin)
DEFINE_R3TYPE(ldn3_shift3)
DEFINE_R3TYPE(ldn3_vidxcompv3)
DEFINE_RTYPE(ld_sign)
DEFINE_RTYPE(ld_abs)
DEFINE_RTYPE(ld_max)
DEFINE_RTYPE(ld_min)
DEFINE_RTYPE(ld_nmess)
DEFINE_RTYPE(ld_subsat)
DEFINE_RTYPE(ld_eval)
DEFINE_RTYPE(ld_rsign)
DEFINE_RTYPE(ld_addsat)
DEFINE_RTYPE(ld_storeu)
DEFINE_RTYPE(ld_xorb)
DEFINE_RTYPE(ld_copysign)
DEFINE_RTYPE(ld_cmpeq)
DEFINE_RTYPE(ld_maxu)
DEFINE_RTYPE(ld_minu)
DEFINE_RTYPE(ld_maxsub)
DEFINE_R3TYPE(ld3_sign3)
DEFINE_R3TYPE(ld3_minmax)
DEFINE_R3TYPE(ld3_rsign_nmess)
DEFINE_R3TYPE(ld3_min_sorting)
DEFINE_R3TYPE(ld3_maxsub)
DEFINE_R3TYPE(ld3_readvn)
DEFINE_R3TYPE(ld3_blendv)
DEFINE_R3TYPE(ld3_copysignr3)
