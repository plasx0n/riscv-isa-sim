...
#define INSN_FIELD_C_SREG2 0x1c
   ...
   //INSN
    #define MATCH_TB_SUBSAT 0x800005b
#define MASK_TB_SUBSAT 0xfe00707f
#define MATCH_TB_ADDSAT 0x800105b
#define MASK_TB_ADDSAT 0xfe00707f
#define MATCH_TB_MAX 0x800205b
#define MASK_TB_MAX 0xfe00707f
#define MATCH_TB_VMAX 0x800305b
#define MASK_TB_VMAX 0xfe00707f
#define MATCH_TB_SCALE 0x800405b
#define MASK_TB_SCALE 0xfe00707f
#define MATCH_TB_VSRLS 0x800505b
#define MASK_TB_VSRLS 0xfe00707f
#define MATCH_TB_DIV2ADD 0x800605b
#define MASK_TB_DIV2ADD 0xfe00707f
#define MATCH_TB_DIV2SUB 0x800705b
#define MASK_TB_DIV2SUB 0xfe00707f
#define MATCH_TB_SAT63 0x1000005b
#define MASK_TB_SAT63 0xfe00707f
#define MATCH_TB_VSUBS 0x1000105b
#define MASK_TB_VSUBS 0xfe00707f
#define MATCH_TB_VADDS 0x1000205b
#define MASK_TB_VADDS 0xfe00707f
#define MATCH_TB_DIV34 0x1000305b
#define MASK_TB_DIV34 0xfe00707f
#define MATCH_TB_SHUFFLE 0x1000405b
#define MASK_TB_SHUFFLE 0xfe00707f
#define MATCH_TB_VSUBSAT 0x1000505b
#define MASK_TB_VSUBSAT 0xfe00707f
#define MATCH_TB_VADDSCALE 0x1000605b
#define MASK_TB_VADDSCALE 0xfe00707f
#define MATCH_TB3_ACCUMAX 0x200005b
#define MASK_TB3_ACCUMAX 0x600707f
#define MATCH_TB3_ACCUPP 0x200105b
#define MASK_TB3_ACCUPP 0x600707f
#define MATCH_TB3_ACCUMP 0x200205b
#define MASK_TB3_ACCUMP 0x600707f
#define MATCH_TB3_ADDLLSA 0x200305b
#define MASK_TB3_ADDLLSA 0x600707f
#define MATCH_TB3_MAXPM 0x200405b
#define MASK_TB3_MAXPM 0x600707f
#define MATCH_TB3_MAXADDSUB 0x200505b
#define MASK_TB3_MAXADDSUB 0x600707f
#define MATCH_TB3_BLENDV 0x200605b
#define MASK_TB3_BLENDV 0x600707f
#define MATCH_TB3_CONCADDADD 0x200705b
#define MASK_TB3_CONCADDADD 0x600707f
#define MATCH_TB3_CONCADDSUB 0x400005b
#define MASK_TB3_CONCADDSUB 0x600707f
#define MATCH_TB3_ADDSRLA 0x400105b
#define MASK_TB3_ADDSRLA 0x600707f
#define MATCH_TB3_SUBSRLA 0x400205b
#define MASK_TB3_SUBSRLA 0x600707f
...
#define MATCH_LDN_ADD32U_SAT64 0x7b
#define MASK_LDN_ADD32U_SAT64 0xfe00707f
#define MATCH_LDN_VIDXMINUPDATE2 0x107b
#define MASK_LDN_VIDXMINUPDATE2 0xfe00707f
#define MATCH_LDN_MIN 0x207b
#define MASK_LDN_MIN 0xfe00707f
#define MATCH_LDN_SAT8 0x307b
#define MASK_LDN_SAT8 0xfe00707f
#define MATCH_LDN_ADD32S_SAT64 0x407b
#define MASK_LDN_ADD32S_SAT64 0xfe00707f
#define MATCH_LDN_SUB32S_SAT64 0x507b
#define MASK_LDN_SUB32S_SAT64 0xfe00707f
#define MATCH_LDN_VIDXMINCOMP 0x607b
#define MASK_LDN_VIDXMINCOMP 0xfe00707f
#define MATCH_LDN_VIDXMINUPDATE 0x707b
#define MASK_LDN_VIDXMINUPDATE 0xfe00707f
#define MATCH_LDN_EXTRACT 0x200007b
#define MASK_LDN_EXTRACT 0xfe00707f
#define MATCH_LDN3_MAXSUB 0x600007b
#define MASK_LDN3_MAXSUB 0x600707f
#define MATCH_LDN3_COPYXORVECTO 0x600107b
#define MASK_LDN3_COPYXORVECTO 0x600707f
#define MATCH_LDN3_READVN 0x600207b
#define MASK_LDN3_READVN 0x600707f
#define MATCH_LDN3_ADDSATMIN 0x600307b
#define MASK_LDN3_ADDSATMIN 0x600707f
#define MATCH_LDN3_SHIFT3 0x600407b
#define MASK_LDN3_SHIFT3 0x600707f
#define MATCH_LDN3_VIDXCOMPV3 0x600507b
#define MASK_LDN3_VIDXCOMPV3 0x600707f
#define MATCH_LD_SIGN 0xb
#define MASK_LD_SIGN 0xfe00707f
#define MATCH_LD_ABS 0x100b
#define MASK_LD_ABS 0xfe00707f
#define MATCH_LD_MAX 0x200b
#define MASK_LD_MAX 0xfe00707f
#define MATCH_LD_MIN 0x300b
#define MASK_LD_MIN 0xfe00707f
#define MATCH_LD_NMESS 0x400b
#define MASK_LD_NMESS 0xfe00707f
#define MATCH_LD_SUBSAT 0x500b
#define MASK_LD_SUBSAT 0xfe00707f
#define MATCH_LD_EVAL 0x200000b
#define MASK_LD_EVAL 0xfe00707f
#define MATCH_LD_RSIGN 0x200100b
#define MASK_LD_RSIGN 0xfe00707f
#define MATCH_LD_ADDSAT 0x200200b
#define MASK_LD_ADDSAT 0xfe00707f
#define MATCH_LD_STOREU 0x600b
#define MASK_LD_STOREU 0xfe00707f
#define MATCH_LD_XORB 0x700b
#define MASK_LD_XORB 0xfe00707f
#define MATCH_LD_COPYSIGN 0x200300b
#define MASK_LD_COPYSIGN 0xfe00707f
#define MATCH_LD_CMPEQ 0x200400b
#define MASK_LD_CMPEQ 0xfe00707f
#define MATCH_LD_MAXU 0x200500b
#define MASK_LD_MAXU 0xfe00707f
#define MATCH_LD_MINU 0x200600b
#define MASK_LD_MINU 0xfe00707f
#define MATCH_LD_MAXSUB 0x200700b
#define MASK_LD_MAXSUB 0xfe00707f
...
#define MATCH_LD3_RSIGN_NMESS 0x600200b
#define MASK_LD3_RSIGN_NMESS 0x600707f
...
#define MATCH_LD3_BLENDV 0x600700b
#define MASK_LD3_BLENDV 0x600707f
#define MATCH_LD3_COPYSIGNR3 0x600500b
#define MASK_LD3_COPYSIGNR3 0x600707f



#endif
#ifdef DECLARE_INSN
DECLARE_INSN(tb_subsat, MATCH_TB_SUBSAT, MASK_TB_SUBSAT)
DECLARE_INSN(tb_addsat, MATCH_TB_ADDSAT, MASK_TB_ADDSAT)
DECLARE_INSN(tb_max, MATCH_TB_MAX, MASK_TB_MAX)
DECLARE_INSN(tb_vmax, MATCH_TB_VMAX, MASK_TB_VMAX)
DECLARE_INSN(tb_scale, MATCH_TB_SCALE, MASK_TB_SCALE)
DECLARE_INSN(tb_vsrls, MATCH_TB_VSRLS, MASK_TB_VSRLS)
DECLARE_INSN(tb_div2add, MATCH_TB_DIV2ADD, MASK_TB_DIV2ADD)
DECLARE_INSN(tb_div2sub, MATCH_TB_DIV2SUB, MASK_TB_DIV2SUB)
DECLARE_INSN(tb_sat63, MATCH_TB_SAT63, MASK_TB_SAT63)
DECLARE_INSN(tb_vsubs, MATCH_TB_VSUBS, MASK_TB_VSUBS)
DECLARE_INSN(tb_vadds, MATCH_TB_VADDS, MASK_TB_VADDS)
DECLARE_INSN(tb_div34, MATCH_TB_DIV34, MASK_TB_DIV34)
DECLARE_INSN(tb_shuffle, MATCH_TB_SHUFFLE, MASK_TB_SHUFFLE)
DECLARE_INSN(tb_vsubsat, MATCH_TB_VSUBSAT, MASK_TB_VSUBSAT)
DECLARE_INSN(tb_vaddscale, MATCH_TB_VADDSCALE, MASK_TB_VADDSCALE)
DECLARE_INSN(tb3_accumax, MATCH_TB3_ACCUMAX, MASK_TB3_ACCUMAX)
DECLARE_INSN(tb3_accupp, MATCH_TB3_ACCUPP, MASK_TB3_ACCUPP)
DECLARE_INSN(tb3_accump, MATCH_TB3_ACCUMP, MASK_TB3_ACCUMP)
DECLARE_INSN(tb3_addllsa, MATCH_TB3_ADDLLSA, MASK_TB3_ADDLLSA)
DECLARE_INSN(tb3_maxpm, MATCH_TB3_MAXPM, MASK_TB3_MAXPM)
DECLARE_INSN(tb3_maxaddsub, MATCH_TB3_MAXADDSUB, MASK_TB3_MAXADDSUB)
DECLARE_INSN(tb3_blendv, MATCH_TB3_BLENDV, MASK_TB3_BLENDV)
DECLARE_INSN(tb3_concaddadd, MATCH_TB3_CONCADDADD, MASK_TB3_CONCADDADD)
DECLARE_INSN(tb3_concaddsub, MATCH_TB3_CONCADDSUB, MASK_TB3_CONCADDSUB)
DECLARE_INSN(tb3_addsrla, MATCH_TB3_ADDSRLA, MASK_TB3_ADDSRLA)
DECLARE_INSN(tb3_subsrla, MATCH_TB3_SUBSRLA, MASK_TB3_SUBSRLA)
DECLARE_INSN(pl_f, MATCH_PL_F, MASK_PL_F)
DECLARE_INSN(pl_r, MATCH_PL_R, MASK_PL_R)
DECLARE_INSN(pl_addsat, MATCH_PL_ADDSAT, MASK_PL_ADDSAT)
DECLARE_INSN(pl_subsat, MATCH_PL_SUBSAT, MASK_PL_SUBSAT)
DECLARE_INSN(pl_decode, MATCH_PL_DECODE, MASK_PL_DECODE)
DECLARE_INSN(pl_eval, MATCH_PL_EVAL, MASK_PL_EVAL)
DECLARE_INSN(pl_rep_addlow, MATCH_PL_REP_ADDLOW, MASK_PL_REP_ADDLOW)
DECLARE_INSN(pl_rep_addhi, MATCH_PL_REP_ADDHI, MASK_PL_REP_ADDHI)
DECLARE_INSN(pl_rep_addsign, MATCH_PL_REP_ADDSIGN, MASK_PL_REP_ADDSIGN)
DECLARE_INSN(pl_spc_acmp, MATCH_PL_SPC_ACMP, MASK_PL_SPC_ACMP)
DECLARE_INSN(pl_spc_amin, MATCH_PL_SPC_AMIN, MASK_PL_SPC_AMIN)
DECLARE_INSN(pl_spc_idup, MATCH_PL_SPC_IDUP, MASK_PL_SPC_IDUP)
DECLARE_INSN(pl_spc_max, MATCH_PL_SPC_MAX, MASK_PL_SPC_MAX)
DECLARE_INSN(pl_rep_addsum, MATCH_PL_REP_ADDSUM, MASK_PL_REP_ADDSUM)
DECLARE_INSN(pl_spc_xorsum, MATCH_PL_SPC_XORSUM, MASK_PL_SPC_XORSUM)
DECLARE_INSN(pl_spc_minapos, MATCH_PL_SPC_MINAPOS, MASK_PL_SPC_MINAPOS)
DECLARE_INSN(pl3_g, MATCH_PL3_G, MASK_PL3_G)
DECLARE_INSN(pl3_idx_min_comp, MATCH_PL3_IDX_MIN_COMP, MASK_PL3_IDX_MIN_COMP)
DECLARE_INSN(pl3_sc_update, MATCH_PL3_SC_UPDATE, MASK_PL3_SC_UPDATE)
DECLARE_INSN(pl3_findminpos, MATCH_PL3_FINDMINPOS, MASK_PL3_FINDMINPOS)
DECLARE_INSN(ldn_add32u_sat64, MATCH_LDN_ADD32U_SAT64, MASK_LDN_ADD32U_SAT64)
DECLARE_INSN(ldn_vidxminupdate2, MATCH_LDN_VIDXMINUPDATE2, MASK_LDN_VIDXMINUPDATE2)
DECLARE_INSN(ldn_min, MATCH_LDN_MIN, MASK_LDN_MIN)
DECLARE_INSN(ldn_sat8, MATCH_LDN_SAT8, MASK_LDN_SAT8)
DECLARE_INSN(ldn_add32s_sat64, MATCH_LDN_ADD32S_SAT64, MASK_LDN_ADD32S_SAT64)
DECLARE_INSN(ldn_sub32s_sat64, MATCH_LDN_SUB32S_SAT64, MASK_LDN_SUB32S_SAT64)
DECLARE_INSN(ldn_vidxmincomp, MATCH_LDN_VIDXMINCOMP, MASK_LDN_VIDXMINCOMP)
DECLARE_INSN(ldn_vidxminupdate, MATCH_LDN_VIDXMINUPDATE, MASK_LDN_VIDXMINUPDATE)
DECLARE_INSN(ldn_extract, MATCH_LDN_EXTRACT, MASK_LDN_EXTRACT)
DECLARE_INSN(ldn3_maxsub, MATCH_LDN3_MAXSUB, MASK_LDN3_MAXSUB)
DECLARE_INSN(ldn3_copyxorvecto, MATCH_LDN3_COPYXORVECTO, MASK_LDN3_COPYXORVECTO)
DECLARE_INSN(ldn3_readVn, MATCH_LDN3_READVN, MASK_LDN3_READVN)
DECLARE_INSN(ldn3_addsatmin, MATCH_LDN3_ADDSATMIN, MASK_LDN3_ADDSATMIN)
DECLARE_INSN(ldn3_shift3, MATCH_LDN3_SHIFT3, MASK_LDN3_SHIFT3)
DECLARE_INSN(ldn3_vidxcompv3, MATCH_LDN3_VIDXCOMPV3, MASK_LDN3_VIDXCOMPV3)
DECLARE_INSN(ld_sign, MATCH_LD_SIGN, MASK_LD_SIGN)
DECLARE_INSN(ld_abs, MATCH_LD_ABS, MASK_LD_ABS)
DECLARE_INSN(ld_max, MATCH_LD_MAX, MASK_LD_MAX)
DECLARE_INSN(ld_min, MATCH_LD_MIN, MASK_LD_MIN)
DECLARE_INSN(ld_nmess, MATCH_LD_NMESS, MASK_LD_NMESS)
DECLARE_INSN(ld_subsat, MATCH_LD_SUBSAT, MASK_LD_SUBSAT)
DECLARE_INSN(ld_eval, MATCH_LD_EVAL, MASK_LD_EVAL)
DECLARE_INSN(ld_rsign, MATCH_LD_RSIGN, MASK_LD_RSIGN)
DECLARE_INSN(ld_addsat, MATCH_LD_ADDSAT, MASK_LD_ADDSAT)
DECLARE_INSN(ld_storeu, MATCH_LD_STOREU, MASK_LD_STOREU)
DECLARE_INSN(ld_xorb, MATCH_LD_XORB, MASK_LD_XORB)
DECLARE_INSN(ld_copysign, MATCH_LD_COPYSIGN, MASK_LD_COPYSIGN)
DECLARE_INSN(ld_cmpeq, MATCH_LD_CMPEQ, MASK_LD_CMPEQ)
DECLARE_INSN(ld_maxu, MATCH_LD_MAXU, MASK_LD_MAXU)
DECLARE_INSN(ld_minu, MATCH_LD_MINU, MASK_LD_MINU)
DECLARE_INSN(ld_maxsub, MATCH_LD_MAXSUB, MASK_LD_MAXSUB)
DECLARE_INSN(ld3_sign3, MATCH_LD3_SIGN3, MASK_LD3_SIGN3)
DECLARE_INSN(ld3_minmax, MATCH_LD3_MINMAX, MASK_LD3_MINMAX)
DECLARE_INSN(ld3_rsign_nmess, MATCH_LD3_RSIGN_NMESS, MASK_LD3_RSIGN_NMESS)
DECLARE_INSN(ld3_min_sorting, MATCH_LD3_MIN_SORTING, MASK_LD3_MIN_SORTING)
DECLARE_INSN(ld3_maxsub, MATCH_LD3_MAXSUB, MASK_LD3_MAXSUB)
DECLARE_INSN(ld3_readvn, MATCH_LD3_READVN, MASK_LD3_READVN)
DECLARE_INSN(ld3_blendv, MATCH_LD3_BLENDV, MASK_LD3_BLENDV)
DECLARE_INSN(ld3_copysignr3, MATCH_LD3_COPYSIGNR3, MASK_LD3_COPYSIGNR3)
