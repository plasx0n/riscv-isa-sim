...
#define MATCH_TB_MAX 0x400105b
#define MASK_TB_MAX 0xfe00707f
#define MATCH_TB_SCALE 0x400205b
#define MASK_TB_SCALE 0xfe00707f
#define MATCH_TB_SUBSAT 0x400005b
#define MASK_TB_SUBSAT 0xfe00707f
#define MATCH_TB_ADDSAT 0x400405b
#define MASK_TB_ADDSAT 0xfe00707f
#define MATCH_TB_VMAX 0x400505b
#define MASK_TB_VMAX 0xfe00707f
#define MATCH_TB_VMIN 0x400605b
#define MASK_TB_VMIN 0xfe00707f
#define MATCH_TB_VSRLS 0x400705b
#define MASK_TB_VSRLS 0xfe00707f
#define MATCH_TB_MAXSUB 0x600005b
#define MASK_TB_MAXSUB 0x600707f
#define MATCH_TB_MM_BLENDV_EPI8 0x600105b
#define MASK_TB_MM_BLENDV_EPI8 0x600707f
#define MATCH_TB_MMAX 0x600205b
#define MASK_TB_MMAX 0x600707f
#define MATCH_TB_CONC_ADD 0x600305b
#define MASK_TB_CONC_ADD 0x600707f
#define MATCH_TB_MAX_ADD_SUB 0x600405b
#define MASK_TB_MAX_ADD_SUB 0x600707f
...
DECLARE_INSN(tb_vmin, MATCH_TB_VMIN, MASK_TB_VMIN)
DECLARE_INSN(tb_vsrls, MATCH_TB_VSRLS, MASK_TB_VSRLS)
DECLARE_INSN(tb_maxsub, MATCH_TB_MAXSUB, MASK_TB_MAXSUB)
DECLARE_INSN(tb_mm_blendv_epi8, MATCH_TB_MM_BLENDV_EPI8, MASK_TB_MM_BLENDV_EPI8)
DECLARE_INSN(tb_mmax, MATCH_TB_MMAX, MASK_TB_MMAX)
DECLARE_INSN(tb_conc_add, MATCH_TB_CONC_ADD, MASK_TB_CONC_ADD)
DECLARE_INSN(tb_max_add_sub, MATCH_TB_MAX_ADD_SUB, MASK_TB_MAX_ADD_SUB)
